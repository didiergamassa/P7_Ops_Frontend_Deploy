...
###############################################################################    
    ...
    html_temp1 = """
     ...
     <h3 style="color: black; text-align:center">Credit Risk Project implemented,by Didier GAMASSA(IT_Project_Manager&Data_Scientist),with the support of OpenClassrooms</h3>
